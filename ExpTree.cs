...
namespace ArithmeticExpressionTreeHW3CptS322
{
    class ExpTree
    {
        ...
        {
            public Node L, R;//Left, Right children
        ...
        public Dictionary<string, double> DictionaryVariables = new Dictionary<string, double>(); //variable dictionary declartion
        ...
        public Node Compile(string inputexpression)
        {
            ...
            char[] operArr = ExpTree.PossibleOperands;
        ...
        public double Evaluate(Node NodeArg)
        {
        ...
        public void SetVariable(Node rootNode, string VariableName, double VarValue)
        {
